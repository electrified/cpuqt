...
std::string Disassembler::getDisassembly(std::uint16_t index) { return this->results.at(index); }
...
void Disassembler::AND(const Rgstr r) { add(boost::str(boost::format("AND %s") % registers::toString(r))); }

void Disassembler::AND(const std::uint8_t i) { add(boost::str(boost::format("AND %s") % utils::int_to_hex(i))); }
...
void Disassembler::CCF() { add("CCF"); }

void Disassembler::CP(const std::uint8_t val) { add(boost::str(boost::format("CP %s") % utils::int_to_hex(val))); }

void Disassembler::CP(const Rgstr val) { add(boost::str(boost::format("CP %s") % registers::toString(val))); }

void Disassembler::CP(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("CP %s") % memoryAddress.toString()));
}

void Disassembler::CPD() { add("CPD"); }

void Disassembler::CPDR() { add("CPDR"); }

void Disassembler::CPI() { add("CPI"); }

void Disassembler::CPIR() { add("CPIR"); }

void Disassembler::CPL() { add("CPL"); }

void Disassembler::DAA() { add("DAA"); }

void Disassembler::DEC(const Rgstr r) { add(boost::str(boost::format("DEC %s") % registers::toString(r))); }

void Disassembler::DEC(const RegisterPair r) { add(boost::str(boost::format("DEC %s") % registers::toString(r))); }

void Disassembler::DEC(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("DEC %s") % memoryAddress.toString()));
}

void Disassembler::DI() { add("DI"); }

void Disassembler::DJNZ(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("DJNZ %s") % memoryAddress.toString()));
}

void Disassembler::EI() { add("EI"); }
...
void Disassembler::EXX() { add("EXX"); }

void Disassembler::HALT() { add("HALT"); }
...
void Disassembler::INC(const Rgstr r) { add(boost::str(boost::format("INC %s") % registers::toString(r))); }

void Disassembler::INC(const RegisterPair r) { add(boost::str(boost::format("INC %s") % registers::toString(r))); }

void Disassembler::INC(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("INC %s") % memoryAddress.toString()));
}

void Disassembler::IND() { add("IND"); }

void Disassembler::INDR() { add("INDR"); }

void Disassembler::INI() { add("INI"); }

void Disassembler::INIR() { add("INIR"); }
...
void Disassembler::LDD() { add("LDD"); }

void Disassembler::LDDR() { add("LDDR"); }

void Disassembler::LDI() { add("LDI"); }

void Disassembler::LDIR() { add("LDIR"); }

void Disassembler::NEG() { add("NEG"); }

void Disassembler::NOP() { add("NOP"); }

void Disassembler::OR(const Rgstr r) { add(boost::str(boost::format("OR %s") % registers::toString(r))); }
...
void Disassembler::OTDR() { add("OTDR"); }

void Disassembler::OTIR() { add("OTIR"); }
...
void Disassembler::OUTD() { add("OUTD"); }

void Disassembler::OUTI() { add("OUTI"); }

void Disassembler::POP(const RegisterPair r) { add(boost::str(boost::format("POP %s") % registers::toString(r))); }

void Disassembler::PUSH(const RegisterPair r) { add(boost::str(boost::format("PUSH %s") % registers::toString(r))); }
...
void Disassembler::RET(const Condition c) { add(boost::str(boost::format("RET %s") % registers::toString(c))); }

void Disassembler::RET() { add("RET"); }

void Disassembler::RETI() { add("RETI"); }

void Disassembler::RETN() { add("RETN"); }

void Disassembler::RL(const Rgstr r) { add(boost::str(boost::format("RL %s") % registers::toString(r))); }

void Disassembler::RL(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("RL %s") % memoryAddress.toString()));
}

void Disassembler::RLA() { add("RLA"); }

void Disassembler::RLC(const Rgstr r) { add(boost::str(boost::format("RLC %s") % registers::toString(r))); }

void Disassembler::RLC(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("RLC %s") % memoryAddress.toString()));
}

void Disassembler::RLCA() { add("RLCA"); }

void Disassembler::RLD() { add("RLD"); }

void Disassembler::RR(const Rgstr r) { add(boost::str(boost::format("RR %s") % registers::toString(r))); }

void Disassembler::RR(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("RR %s") % memoryAddress.toString()));
}

void Disassembler::RRA() { add("RRA"); }

void Disassembler::RRC(const Rgstr r) { add(boost::str(boost::format("RRC %s") % registers::toString(r))); }

void Disassembler::RRC(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("RRC %s") % memoryAddress.toString()));
}

void Disassembler::RRCA() { add("RRCA"); }

void Disassembler::RRD() { add("RRD"); }

void Disassembler::RST(const std::uint8_t i) { add(boost::str(boost::format("RST %s") % utils::int_to_hex(i))); }
...
void Disassembler::SLA(const Rgstr r) { add(boost::str(boost::format("SLA %s") % registers::toString(r))); }

void Disassembler::SLA(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("SLA %s") % memoryAddress.toString()));
}

void Disassembler::SRA(const Rgstr r) { add(boost::str(boost::format("SRA %s") % registers::toString(r))); }

void Disassembler::SRA(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("SRA %s") % memoryAddress.toString()));
}

void Disassembler::SRL(const Rgstr r) { add(boost::str(boost::format("SRL %s") % registers::toString(r))); }

void Disassembler::SRL(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("SRL %s") % memoryAddress.toString()));
}

void Disassembler::SUB(const Rgstr r) { add(boost::str(boost::format("SUB %s") % registers::toString(r))); }

void Disassembler::SUB(const std::uint8_t i) { add(boost::str(boost::format("SUB %s") % utils::int_to_hex(i))); }

void Disassembler::SUB(const MemoryAddress memoryAddress) {
  add(boost::str(boost::format("SUB %s") % memoryAddress.toString()));
}

void Disassembler::XOR(const Rgstr r) { add(boost::str(boost::format("XOR %s") % registers::toString(r))); }

void Disassembler::XOR(const std::uint8_t i) { add(boost::str(boost::format("XOR %s") % utils::int_to_hex(i))); }
