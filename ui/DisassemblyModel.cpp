...
int DisassemblyModel::rowCount(const QModelIndex & /*parent*/) const { return this->memory->size(); }

int DisassemblyModel::columnCount(const QModelIndex & /*parent*/) const { return 4; }
...
void DisassemblyModel::forceDisassembly() { this->disassembler->disassemble(); }
